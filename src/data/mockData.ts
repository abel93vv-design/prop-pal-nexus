...
export const users: User[] = [
  { id: 'u1', name: 'Carlos Martínez', email: 'carlos@inmobiliaria.com', role: 'admin_global', phone: '+34 612 345 678', propertyIds: ['p1','p2','p5'], clientIds: ['c1','c2'], avatar: '', agencyId: 'a1', accessType: 'total', permissions: ['ver_clientes','ver_propiedades','ver_tareas','editar_clientes','editar_propiedades','editar_tareas','eliminar_registros','publicar_propiedades'] },
  { id: 'u2', name: 'Ana García', email: 'ana@inmobiliaria.com', role: 'agente', phone: '+34 623 456 789', propertyIds: ['p3','p4'], clientIds: ['c3','c4'], avatar: '', agencyId: 'a1', accessType: 'solo_inmobiliaria', permissions: ['ver_clientes','ver_propiedades','ver_tareas','editar_clientes','editar_propiedades','editar_tareas','publicar_propiedades'] },
  { id: 'u3', name: 'Luis Fernández', email: 'luis@inmobiliaria.com', role: 'agente', phone: '+34 634 567 890', propertyIds: ['p6','p7'], clientIds: ['c5','c6'], avatar: '', agencyId: 'a2', accessType: 'solo_inmobiliaria', permissions: ['ver_clientes','ver_propiedades','ver_tareas','editar_clientes','editar_propiedades','editar_tareas'] },
