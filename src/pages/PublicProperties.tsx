...
import { Building2, MapPin, Bed, Bath, Ruler, Search, Phone, Mail } from "lucide-react";
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-border">
                    ...
                    <Dialog>
                      <DialogTrigger asChild>
                        <Button size="sm" className="text-xs">Contactar</Button>
                      </DialogTrigger>
                      <DialogContent>
                        <DialogHeader>
                          <DialogTitle className="text-lg">Contactar sobre {p.title}</DialogTitle>
                        </DialogHeader>
                        {agent && (
