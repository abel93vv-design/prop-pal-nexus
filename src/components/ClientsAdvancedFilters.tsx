...
const SOURCES = [
  'vivienda','vivienda_vendida','vivienda_eliminada','fotocasa','idealista','milanuncios','habitaclia','oficina','web','redes_sociales',
  'whatsapp','telegram','escaparate','wallapop','publicidad_zona','referido','otros'
];
const SOURCE_LABELS: Record<string, string> = {
  vivienda: 'Por vivienda', vivienda_vendida: 'Vivienda ya vendida', vivienda_eliminada: 'Vivienda eliminada del CRM',
